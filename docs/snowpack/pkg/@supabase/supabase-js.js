...
const resolveFetch = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return browserPonyfill$1; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
var browserPonyfill$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), browserPonyfill, {
    'default': crossFetch
}));
...
const DEFAULT_HEADERS = { 'X-Client-Info': `postgrest-js/${version}` };
...
class RealtimeClient {
    ...
    constructor(endPoint, options) {
        ...
        this.reconnectTimer = new Timer(() => __awaiter$3(this, void 0, void 0, function* () {
            this.disconnect();
            this.connect();
...
const resolveFetch$1 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter$4(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return browserPonyfill$1; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
const resolveResponse = () => __awaiter$4(void 0, void 0, void 0, function* () {
    if (typeof Response === 'undefined') {
        return (yield Promise.resolve().then(function () { return browserPonyfill$1; })).Response;
    }
    return Response;
});
...
const handleError = (error, reject) => __awaiter$5(void 0, void 0, void 0, function* () {
...
const version$5 = '2.24.0';

// constants.ts
const DEFAULT_HEADERS$3 = { 'X-Client-Info': `supabase-js/${version$5}` };
...
const resolveHeadersConstructor = () => {
    if (typeof Headers === 'undefined') {
        return browserPonyfill.Headers;
    }
    return Headers;
};
const fetchWithAuth = (supabaseKey, getAccessToken, customFetch) => {
    const fetch = resolveFetch$2(customFetch);
    const HeadersConstructor = resolveHeadersConstructor();
    return (input, init) => __awaiter$8(void 0, void 0, void 0, function* () {
        var _a;
...
const resolveFetch$3 = (customFetch) => {
    ...
    if (customFetch) {
        ...
        _fetch = (...args) => __awaiter$9(void 0, void 0, void 0, function* () { return yield (yield Promise.resolve().then(function () { return browserPonyfill$1; })).fetch(...args); });
    }
    else {
        _fetch = fetch;
    }
...
const handleError$1 = (error, reject) => __awaiter$a(void 0, void 0, void 0, function* () {
    const NETWORK_ERROR_CODES = [502, 503, 504];
    if (!looksLikeFetchResponse(error)) {
        reject(new AuthRetryableFetchError(_getErrorMessage$1(error), 0));
    }
    else if (NETWORK_ERROR_CODES.includes(error.status)) {
        // status in 500...599 range - server had an error, request might be retryed.
        reject(new AuthRetryableFetchError(_getErrorMessage$1(error), error.status));
    }
    else {
        ...
        error
            .json()
            .then((err) => {
            reject(new AuthApiError(_getErrorMessage$1(err), error.status || 500));
        })
            .catch((e) => {
            // not a valid json response
            reject(new AuthUnknownError(_getErrorMessage$1(e), e));
        });
    }
});
...
function _request(fetcher, method, url, options) {
    ...
    return __awaiter$a(this, void 0, void 0, function* () {
        ...
        const data = yield _handleRequest$1(fetcher, method, url + queryString, { headers, noResolveJson: options === null || options === void 0 ? void 0 : options.noResolveJson }, {}, options === null || options === void 0 ? void 0 : options.body);
...
// Generated by genversion.
const version$6 = '2.28.0';

const GOTRUE_URL = 'http://localhost:9999';
const STORAGE_KEY = 'supabase.auth.token';
const DEFAULT_HEADERS$4 = { 'X-Client-Info': `gotrue-js/${version$6}` };
...
class GoTrueClient {
    ...
    constructor(options) {
        ...
        this.fetch = resolveFetch$3(settings.fetch);
    ...
    _refreshAccessToken(refreshToken) {
        return __awaiter$c(this, void 0, void 0, function* () {
            try {
                ...
                return yield retryable((attempt) => __awaiter$c(this, void 0, void 0, function* () {
    ...
    _handleVisibilityChange() {
        return __awaiter$c(this, void 0, void 0, function* () {
            ...
            try {
                this.visibilityChangedCallback = () => __awaiter$c(this, void 0, void 0, function* () { return yield this._onVisibilityChanged(false); });
